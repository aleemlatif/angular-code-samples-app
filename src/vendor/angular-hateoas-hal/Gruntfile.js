module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		karma: {
			...
			continuous: { // Karma target intended to be run in a continuous integration environment; should set up things like headless browsers or environmental details specific to your CI server.
                configFile: "karma.conf.js",
				singleRun: true
			}
		}
